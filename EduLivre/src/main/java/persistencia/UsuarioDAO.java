...
import java.sql.Connection; // Importe o Enum
...
public class UsuarioDAO {
    ...
    public void inserirUsuarioCompleto(String nome, String email, String senha, String perfilStr) throws SQLException {
        ...
        try {
            PerfilUsuario perfil = PerfilUsuario.valueOf(perfilStr.toUpperCase()); // Converte a String para Enum
            usuario.setPerfil(perfil);
            inserir(usuario);
        } catch (IllegalArgumentException e) {
            System.out.println("Perfil de usuário inválido: " + perfilStr + ". Use 'aluno', 'professor' ou 'admin'.");
            // Aqui, você pode optar por lançar a exceção novamente, retornar, ou usar um perfil padrão.  Escolhi retornar para evitar a inserção.
        }
    }
    ...
    public List<Usuario> listarTodos() throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            while (rs.next()) {
                ...
                usuario.setSenha(rs.getString("senha"));
                 usuario.setPerfil(PerfilUsuario.valueOf(rs.getString("perfil"))); // Converte a String de volta para Enum
                System.out.println(usuario); // Depende se o toString() de Usuario está implementado
            }
        }
        return usuarios;
    }
    ...
    public void atualizar(Usuario usuario) throws SQLException {
        ...
        try (Connection conn = Conexao.conectar(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setString(4, usuario.getPerfil().toString()); // Salva o Enum como String
        ...
        if (usuario != null) {
            ...
            if (!novoPerfilStr.isEmpty()) {
                try {
                    ...
                    // Não alteramos o perfil se a entrada for inválida.
                }
            }
